...
@endif               
 <form method="post" action="{{ route('users.update',$user->id) }}" id="frmCheckout">
        @method('PUT')
             @csrf
        ...
        <div class="row">
           <div class="col-md-5">
             <div class="form-group row">
                ...
                <input id="name" type="text" class="form-control" name="name" value="{{$user->name}}" autofocus="" style="width: 70%">
             </div>
            </div><div class="col-md-1"></div>
            <div class="col-md-5">
             <div class="form-group row">
                <label for="email" style="width:20%">Email <span class="required-star"></span></label>
                <input id="email" type="email" class="form-control" name="email" value="{{$user->email}}" autofocus="" style="width: 70%">
             </div>
            </div>
      </div>
        <div class="row">
          ...
          <div class="col-md-5">
             <div class="form-group row">
                ...
                <input id="phone" type="text" class="form-control" name="phone" value="{{$user->phone}}" autofocus="" style="width: 70%">
             </div>
            </div>
