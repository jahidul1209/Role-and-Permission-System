...
<section class="content">
   ...
   <form method="post" action="{{ route('software.store') }}" id="frmCheckout">
         @csrf
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                <label for="soft_name">Software Name<span class="required-star"></span></label>
                <input id="soft_name" type="text" class="form-control" name="soft_name" value="" autofocus="">
